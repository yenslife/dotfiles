...
# donut
export PATH=$PATH:/Users/mac/ASCII-art
...
alias uploadnote='cd ~/Documents/Obsidian\ Vault ; git pull ; git add . ; git commit -m "`date`" ; git push ; cd - ' # Upload Obsidian Note
...
# Jmeter
export PATH=$PATH:/Users/mac/Downloads/apache-jmeter-5.6.3/bin
...
# starship
# 要先安裝 curl -sS https://starship.rs/install.sh | sh
export STARSHIP_CONFIG="$HOME/.config/starship.toml"
eval "$(starship init zsh)"

# uv run nvim
alias uvnvim='uv run nvim'
